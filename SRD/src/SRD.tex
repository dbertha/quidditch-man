...
\section{Exigences fonctionnelles}
  ...
  \end{figure}  
    Une fois que l'utilisateur a rejoint sa \gls{partie}\index{partie} ou en a créé une nouvelle, il peut gérer son équipe. Le manager peut alors au choix se renseigner sur ses joueurs, et donc voir les capacitiés de ces derniers, l'avancement de leurs entraînements, etc. Il peut également envoyer un joueur au centre d'entraînement ou à l'hôpital.
...
\end{itemize}
    \begin{figure}[H]
    \center
    \includegraphics[scale=0.3]{uml/Clientserveur.png}
...
Jusqu'à présent nous allouons un buffer de taille fixe.
    ...
    \begin{figure}[H]
    \center
    \includegraphics[scale=0.3]{uml/Serveur.png}
...
Comme le serveur, le client utilise la fonction select() afin de pouvoir capter indifféremment des messages d'origine différente,
 ...
 sans qu'il puisse être interrompu par un autre message non sollicité ou par une autre demande du manager au clavier.
  ...
  \begin{figure}[H]
    \center
    \includegraphics[scale=0.3]{uml/Client.png}
