...
\subsection{Diagramme de composants}
    ...
    \end{figure}
    Pour la phase suivante, nous veillerons à extraire le code client tout ce qui concerne la gestion "terminal-only",
    responsabilité que nous attribuerons à une classe dédiée.
