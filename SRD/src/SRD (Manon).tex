...
\hypersetup{
    ...
    pdftitle={Quidditch Manager 2014 : Software Requirements Document},    % title
    pdfauthor={Groupe 4},                     % author
    pdfsubject={Software Requirements Document of the videogame Quidditch Manager 2014},                        % subject of the document
...
\section{Historique du document}
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    2.1 & Manon & 06/03/14 & Titre + Section 2.1 \\
    2.2 & Manon & 12/03/14 & Amélioration diags de classes \\
    \hline
  \end{tabular}
...
\textbf{Match} : A tout moment, s'il possède au moins 7 joueurs disponibles, le Manager peut envoyer une demande de match amical à un autre client connecté. Si la réponse de ce dernier est positive, le match débutera. Ce match de Quidditch se déroule au tour par tour. Chacun de leur côté, les adversaires choisissent les mouvements qu'ils veulent que leurs joueurs fassent, sans savoir ce qu'a préparé l'autre manager. Et ainsi de suite jusqu'à une situation de fin de partie. \\
  ...
  Dans cette partie sera expliquée l'implémentation générale du jeu; de quelles façons les fonctionnalités ont été mises en place, les choix faits, etc. Des diagrammes de classes viendront détailler ces explications.
    ...
    \begin{figure}[H]
      \includegraphics[scale=0.27]{uml/class/Global.png}%<---angle here
...
\\
      ...
      \subsubsection{Enchères}
          \begin{figure}[H]
          \center
          \includegraphics[scale=0.4]{uml/class/Auctions.png}
      ...
      \subsubsection{Matches}
          \begin{figure}[H]
          \includegraphics[scale=0.35]{uml/class/Matches.png}
...
En raison des contraintes temporelles qui nous sont imposées, le prototype de jeu que nous rendons a été simplifié un maximum, de sorte que ses fonctionnalités, même si peu nombreuses, soient opérationnelles. Au départ, les ambitions étaient grandes, et nous avions prévu de faire beaucoup de choses que nous n'avons malheureusement pas eu l'occasion d'implémenter. Par exemple, nous avions en tête un plus grand nombre de bâtiments, avec un bar où les fans de l'équipe iraient boire et regarder les matches en extérieur, procurant ainsi des bénéfices au manager même quand le match ne se déroule pas dans son stade. Un magasin à balais était aussi prévu, et le manager aurait pu y acheter des balais de qualité dont les bonus auraient été fort utiles pour ses joueurs, particulièrement ceux moins doués.\\

De même pour l'interface graphique, l'idée de base était bien différente de ce qui est rendu.
