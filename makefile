...
Serveur.out : NetworkBase.o ${SERVERDIR}MatchesHandler.cpp ${SERVERDIR}MatchesHandler.hpp ${SERVERDIR}Match.cpp ${SERVERDIR}Match.hpp ${SERVERDIR}PlayingPlayer.cpp ${SERVERDIR}PlayingPlayer.hpp ${COMMONDIR}HexagonalField.cpp ${COMMONDIR}HexagonalField.hpp ${COMMONDIR}Coordinates.hpp ${COMMONDIR}Defines.hpp ${SERVERDIR}Server.hpp ${SERVERDIR}User.hpp ${SERVERDIR}ServerMain.cpp ${SERVERDIR}Server.cpp ${SERVERDIR}User.cpp ${SERVERDIR}CommonMgr.cpp ${SERVERDIR}CommonMgr.hpp ${COMMONDIR}commAPI.cpp  ${COMMONDIR}commAPI.hpp ${SERVERDIR}Manager.hpp ${SERVERDIR}Manager.cpp ${SERVERDIR}Player.cpp ${SERVERDIR}ManagedPlayer.cpp ${SERVERDIR}Broomstick.cpp ${SERVERDIR}Saver.cpp ${SERVERDIR}TrainingCenter.cpp ${SERVERDIR}Hospital.cpp ${SERVERDIR}RecruitmentCenter.cpp ${SERVERDIR}FanShop.cpp ${SERVERDIR}Stadium.cpp ${SERVERDIR}ImprovementBuilding.cpp ${SERVERDIR}Building.cpp ${SERVERDIR}Calendar.cpp ${SERVERDIR}Player.hpp ${SERVERDIR}ManagedPlayer.hpp ${SERVERDIR}Broomstick.hpp ${SERVERDIR}Saver.hpp ${SERVERDIR}TrainingCenter.hpp ${SERVERDIR}Hospital.hpp ${SERVERDIR}RecruitmentCenter.hpp ${SERVERDIR}FanShop.hpp ${SERVERDIR}Stadium.hpp ${SERVERDIR}ImprovementBuilding.hpp ${SERVERDIR}Building.hpp ${SERVERDIR}Calendar.hpp
	${G++} ${DEBUGINFOS} NetworkBase.o ${SERVERDIR}Match.cpp ${SERVERDIR}MatchesHandler.cpp ${SERVERDIR}PlayingPlayer.cpp ${COMMONDIR}HexagonalField.cpp ${SERVERDIR}ServerMain.cpp ${SERVERDIR}Server.cpp ${SERVERDIR}User.cpp ${SERVERDIR}CommonMgr.cpp ${COMMONDIR}commAPI.cpp ${SERVERDIR}Manager.cpp ${SERVERDIR}Player.cpp ${SERVERDIR}ManagedPlayer.cpp ${SERVERDIR}Broomstick.cpp ${SERVERDIR}Saver.cpp ${SERVERDIR}TrainingCenter.cpp ${SERVERDIR}Hospital.cpp ${SERVERDIR}RecruitmentCenter.cpp ${SERVERDIR}FanShop.cpp ${SERVERDIR}Stadium.cpp ${SERVERDIR}ImprovementBuilding.cpp ${SERVERDIR}Building.cpp ${SERVERDIR}Calendar.cpp -o Server.out
